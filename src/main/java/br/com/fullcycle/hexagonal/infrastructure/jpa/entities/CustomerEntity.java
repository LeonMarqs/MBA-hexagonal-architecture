...
public class CustomerEntity {
	...
	public CustomerEntity(TSID id, String name, String cpf, String email) {
		this.id = id;
		this.name = name;
		this.cpf = cpf;
		this.email = email;
	...
	public static CustomerEntity of(final Customer customer) {
		return new CustomerEntity(TSID.from(customer.customerId().value()), customer.name().value(), customer.cpf().value(),
